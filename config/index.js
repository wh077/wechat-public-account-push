export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxd42a3353999a4281",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "ac3ef46ae479a5ac0cf19d18a4e4944b",
  ...
  USERS: [
    {
      ...
      id: "ozsvp5zaf_Qu7krR8gr_IavcX3_0",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "uwdPUsYY62u0hLb5mqZ52J4f13qtBFh_cp5EaxyWIEw",
      // 所在省份
      province: "陕西",
      // 所在城市
      city: "西安",
